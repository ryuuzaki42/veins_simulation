...
unsigned short int generate_routes (unsigned short int lineStart, unsigned short int routeFileNumber) {
    ...
    countVehicleRoutes = 420;   //420 - 210 - 105 - 55
    countVehicleCagegoryT = 20; // 20 -  10 -   5 -  5
    countPBegin = 80;   // 5x   // 80 -  40 -  20 - 10
    insertByTime = 80;  // 5x   // 80 -  40 -  20 - 10
...
//     <route edges="0/3to1/3 1/3to1/2 1/2to1/1 1/1to2/1 2/1to3/1 3/1to4/1 4/1to4/0 4/0to3/0 3/0to2/0 2/0to2/1 2/1to2/2...
    ...
    // Um com id=taxi e outro com id=passenger
    output << "    <vType id=\"taxi\"" << vehDescripType << "color=\"1,1,0\"/>" << endl << endl;
    ...
    output << "    <vType id=\"passenger\"" << vehDescripType << "color=\"0,1,0\"/>" << endl << endl;
